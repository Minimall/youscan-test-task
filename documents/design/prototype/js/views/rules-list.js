        ...
        return `
              <tr class="${zero ? 'zero-fire' : ''}" data-rule="${r.id}">
                ...
                <td class="row-actions-cell">
                  <div class="actions">
                    <button class="row-action" data-act="view" title="View alerts" data-tip="View alerts">${svg('inbox', 13)}</button>
                    <button class="row-action" data-act="edit" title="Edit rule" data-tip="Edit rule">${svg('edit', 13)}</button>
                    <button class="row-action" data-act="delete" title="Delete rule" data-tip="Delete rule" data-tip-pos="right">${svg('trash2', 13)}</button>
                  </div>
                </td>
              </tr>`;
      }).join('')}
